              ...
              {['regular', 'awesome', 'promo'].map(variation => (
                <div style={{width: 300, marginRight: 40}} key={variation}>
                  ...
                  <FormGroup label='Input'>
                    <Input type="text" value={this.state.value} onChange={this.onChange} placeholder='placeholder' variation={variation} />
                  </FormGroup>
                  ...
                  <FormGroup label='Input warning'>
                    <InputStatus type='warning' message='Warning message' >
                      <Input status="warning" type="text" value={this.state.value} onChange={this.onChange} placeholder='placeholder' variation={variation} />
                    </InputStatus>
                  </FormGroup>
                  <FormGroup label='Input error'>
                    <InputStatus type='error' message='Error message' >
                      <Input status="error" type="text" value={this.state.value} onChange={this.onChange} placeholder='placeholder' variation={variation} />
                    </InputStatus>
                  </FormGroup>
                  <FormGroup label='Input disabled'>
                    <Input disabled type="text" value={this.state.value} onChange={this.onChange} placeholder='placeholder' variation={variation} />
                  </FormGroup>
                  <FormGroup label="Input small" size="small">
                    <Input size="small" type="text" value={this.state.value} onChange={this.onChange} placeholder='placeholder' variation={variation} />
                  </FormGroup>
