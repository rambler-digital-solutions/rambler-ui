...
const Main = ({classes}) => (
  <div className={classes.root}>
    <div className={classes.intro}>
      ...
      <Logo />
      <p>
        Ratio — дизайн-система нового Рамблера, созданная для оптимизации работы
        с визуальным языком продуктов и их интерфейсами.
      </p>
    ...
    <div className={classes.hiring}>
      ...
      <p>
        Работа в Рамблере — это возможность создавать продукты для более чем 50
        миллионов пользователей. У нас всегда найдутся места для тех, кто не
        боится сложных задач.
      </p>
      <Button
        type="primary"
