      ...
      <ApplyTheme>
        <div>
          <div>
            ...
            <Tooltip content="Success tooltip" style={{marginRight: '20px'}} status="success">
              <Button type="secondary">Success</Button>
            </Tooltip>
            <Tooltip content="Error tooltip" style={{marginRight: '20px'}} status="error">
              <Button type="secondary">Error</Button>
            </Tooltip>
            <Tooltip content="Warn tooltip" style={{marginRight: '20px'}} status="warning">
          ...
          <div style={{marginTop: '20px'}}>
            ...
            <Tooltip content="Bottom tooltip" position="bottom" style={{marginRight: '20px'}} status="success">
              <Button type="secondary">Bottom</Button>
            </Tooltip>
            <Tooltip content="Left tooltip" position="left" style={{marginRight: '20px'}} status="error">
          ...
          <div style={{marginTop: '50px'}}>
            <FormGroup label='Tooltip on focus'>
              <Tooltip position="right" status="error" content="Some error" isOpened={this.state.isTooltipOpened}>
                <Input
                  status="error"
                  type="text"
