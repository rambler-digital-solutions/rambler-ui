...
describe('Toggle', () => {
  ...
  it('Style Toggle/ToggleOption small', () => {
    const wrapper = mount(
      applyTheme(
        <div style={{width: 480, marginBottom: 20}}>
          <Toggle {...defaultPropsToggle} behavior="radio" block={false}>
            <ToggleOption
            ...
            <ToggleOption {...defaultPropsToggleOption} value="Yandex">
              Яндекс
            </ToggleOption>
          </Toggle>
        </div>
    ...
    expect(togOpt['font-size']).toEqual(
      theme.toggle.sizes.small.fontSize + 'px'
    )
  ...
  it('Style Toggle/ToggleOption medium', () => {
    ...
    expect(nc(togOptStyles.color)).toEqual(
      nc(theme.toggle.colors.disabled.text)
    )
  ...
  it('onChange Toggle', () => {
    const wrapper = mount(
      applyTheme(
        <div style={{width: 480, marginBottom: 20}}>
          <Toggle {...defaultPropsToggle} behavior="toggle">
            <ToggleOption {...defaultPropsToggleOption} value="Rambler">
              Rambler&Co
            </ToggleOption>
            <ToggleOption
              {...defaultPropsToggleOption}
