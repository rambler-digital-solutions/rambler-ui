    ...
    return (
      <ApplyTheme>
        <div>
          {types.map(type => (
            <div key={type}>
              <Button style={{margin: 20}} icon={<ChevronRightIcon/>} iconPosition="right" type={type}>{type}</Button>
              <Button style={{margin: 20}} icon={<ChevronRightIcon/>} iconPosition="right" type={type} loading={true}>{type}</Button>
              <Button style={{margin: 20}} icon={<ChevronRightIcon/>} iconPosition="right" type={type} size="small">{type} small</Button>
              <Button style={{margin: 20}} icon={<ChevronRightIcon/>} iconPosition="right" type={type} disabled={true}>{type} disabled</Button>
            </div>
          ))}
